...
export function NewNoteCard({ onNoteCreated }: NewNoteCardProps) {
  ...
  function handleStartRecording() {
    ...
    speechRecognition.continuous = true // fica gravando até pedir para parar de gravar manualmente
    speechRecognition.maxAlternatives = 1 // retorna apenas 1 alternativa das palavras
    speechRecognition.interimResults = true // traz os resultados conforme for falando

    // é chamada toda vez que a API ouvir algo
